...
<input style="border:none;" readonly=true type="text" name="reloj" size="10"> 
</form> 
                        </div>
                    </div>
            ...
            <div class="well well-sm">
                <form class="form-horizontal" method="post">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-industry"></i></span>
                            <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <textarea id="comentarios" class="form-control"  name="comentarios" placeholder="Comentarios Adicionales" rows="18"></textarea>
                            </div>
                        </div>
