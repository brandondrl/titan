<?php
require_once('C:\xampp\htdocs\titan\model\conexion.php');
session_start();
    ...
    <div>
        ...
        <div id="header-topbar-option-demo" class="page-header-topbar">
            ...
            <div id="wrapper">
                ...
                <li class="active"><a href="clientes.php"><i class="fa fa-users">
        ...
        <h2 class="chat-header">
                                                    ...
                                                    <form class="form-horizontal" method="post">
                                                        <fieldset>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <input id="nombreC" name="nombreC" type="text" placeholder="Nombre y Apellido del Cliente" class="form-control">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <span class="col-md-1 col-md-offset-1 text-center"><i class="fa fa-map-marker"></i></span>
                                                                <div class="col-md-8">
                                                                    <input id="direccion" name="direccion" type="text" placeholder="Dirección de la empresa" class="form-control">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <input id="telefono" name="telefono" type="text" placeholder="Teléfono del Cliente / Empresa" class="form-control">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <span class="col-md-1 col-md-offset-1 text-center"><i class="fa fa-industry"></i></span>
                                                                <div class="col-md-8">
                                                                    <input id="NombreE" name="nombreE" type="text" placeholder="Nombre de la Empresa" class="form-control">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <span class="col-md-1 col-md-offset-1 text-center"><i class="fa fa-pencil-square-o bigicon"></i></span>
                                                                <div class="col-md-8">
                                                                    <textarea id="comentarios" class="form-control"  name="comentarios" placeholder="Comentarios Adicionales" rows="2"></textarea>
                                                                </div>
                                                            </div>
          ...
          <div class="form-group">
            <div class="col-md-12 text-center">
                <button type="submit" id="registroCliente" class="btn btn-primary btn-lg">Registrar Cliente</button>
            </div>
      </div>
  </fieldset>
</form>
