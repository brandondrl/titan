...
if(!isset($_SESSION['cargo'])) {
  ...
  <head>
  	...
  	<link type="text/css" rel="stylesheet" href="styles/paquetes.css">
  	...
  	<div>
  		...
  		<div id="header-topbar-option-demo" class="page-header-topbar">
  			...
  			<div id="wrapper">
  				...
  				<li class="active"><a href="paquetes.php"><i class="fa fa-th-list fa-fw">
							...
							<ul class="chat-box-body">
								<li>
									...
									<div id="page-wrapper">
										...
										<div class="container">
											<div class="row">
												<div class="col-sm-12 great-support-box wow fadeInLeft hidden-xs animated" style="visibility: visible; animation-name: fadeInLeft;">
													<div class="great-support-box-text great-support-box-text-left text-justify">
														<div class="col-sm-4 col-6 col-xs-12 no-padding">
															<div class="features-table">
																<a href="presupuesto.php" class="price-list-a">
																	<ul>
																		<h1>Características</h1>
																		<li>Total de publicaciones mensuales  (Twitter)</li>
																		<li>Diseño de portada y avatar de perfil (Twitter)</li>
																		<li>Nuevos Seguidores (Twitter)</li>
																		<li>Total de publicaciones mensuales (Facebook)</li>
																		<li>Diseño de portada y avatar de perfil (Facebook)</li>
																		<li>Nuevos Seguidores (Facebook)</li>
																		<li>Total de publicaciones mensuales (Instagram)</li>
																		<li>Nuevos Seguidores (Instagram)</li>

																		<li><span style="font-size: 23pt;line-height: 2.9;">Precios (Por mes)</span></li>
																	</ul>
																</a>
															</div>
														</div>
														<!--<div class="col-sm-2 col-3 col-xs-12 no-padding">
															<div class="features-table-free">
																<a href="presupuesto.php" target="_blank" class="price-list-a btn-registrarse-1">
																</a><ul><a href="presupuesto.php" target="_blank" class="price-list-a btn-registrarse-1">
																<h1>Básico</h1>
																<li>60</li>
																<li>Semestral</li>
																<li>500</li>
																...
																</a><li><a href="presupuesto.php" target="_blank" class="price-list-a btn-registrarse-1"><span class="price-li"><strong>2000 BsF</strong></span><br></a><a href="presupuesto.php" class="btn btn-link-1 btn-price btn-registrarse-1"><i class="fa fa-plus" aria-hidden="true"></i>Presupuesto</a></li>
															</ul>
													...
													<div class="col-sm-2 col-3 col-xs-12 no-padding">
														<div class="features-table-free">
															<a href="presupuesto.php" target="_blank" class="price-list-a btn-registrarse-2">
															</a><ul><a href="presupuesto.php" target="_blank" class="price-list-a btn-registrarse-2">
															<h1>Estandar</h1>
															<li>150</li>
															<li>Trimestral</li>
															<li>1000</li>
														...
														</a><li><a href="presupuesto.php" target="_blank" class="price-list-a btn-registrarse-2"><span class="price-li"><strong>4000 BsF</strong></span><br></a><a href="presupuesto.php" class="btn btn-link-1 btn-price btn-registrarse-2"><i class="fa fa-plus" aria-hidden="true"></i>Presupuesto</a></li>
													</ul>
											...
											<div class="col-sm-2 col-3 col-xs-12 no-padding">
												<div class="features-table-free">
													<a href="presupuesto.php" target="_blank" class="price-list-a btn-registrarse-3">
													</a><ul><a href="presupuesto.php" target="_blank" class="price-list-a btn-registrarse-3">
													<h1>Ultra</h1>
													<li>240</li>
													<li>Bimensual</li>
													<li>1500</li>
												...
												</a><li><a href="presupuesto.php" target="_blank" class="price-list-a btn-registrarse-3"><span class="price-li"><strong>6000 BsF</strong></span><br></a><a href="presupuesto.php" class="btn btn-link-1 btn-price btn-registrarse-3"><i class="fa fa-plus" aria-hidden="true"></i>Presupuesto</a></li>
											</ul>
									...
									<div class="col-sm-2 col-3 col-xs-12 no-padding">
										<div class="features-table-paid">
											<a href="presupuesto.php" target="_blank" class="price-list-a btn-registrarse-4">
											</a><ul><a href="presupuesto.php" target="_blank" class="price-list-a btn-registrarse-4">
											<h1>Master</h1>
											<li>330</li>
											<li>Mensual</li>
											<li>2000</li>
										...
										</a><li><a href="presupuesto.php" target="_blank" class="price-list-a btn-registrarse-4"><span class="price-li"><strong>8000 BsF</strong></span><br></a><a href="presupuesto.php" class="btn btn-link-1 btn-price btn-registrarse-4"><i class="fa fa-plus" aria-hidden="true"></i>Presupuesto</a></li>
									</ul>
