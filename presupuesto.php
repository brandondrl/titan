...
if(!isset($_SESSION['cargo'])) {
  ...
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="styles/styles_fac.css">
</head>
<body onload="mueveReloj(),idpresupuesto(),obtenFecha()">
    <div>
        ...
        <li class="active"><a href="presupuesto.php"><i class="fa fa-edit fa-fw">
                            ...
                            <ul class="chat-box-body">
                                <li>
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-sm-12"> 
                                                <form class="form-horizontal well well-custom" method="post" action="pedf.php">
                                                    <fieldset>
                                                        <legend class="text-center header">Solicitud de Presupuesto</legend>


                                                        <div class="form-group">
                                                            <span class="col-md-1 col-md-offset-1 text-center"></span>
                                                            <div class="col-md-8">
                                                              <input id="autocode" name="codigo-presupuesto" type="text" class="form-control" readonly="">
                                                          </div>
                                                      </div>
                                                      ...
                                                      <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input id="nombreC" name="nombre-cliente" type="text" placeholder="Nombre y Apellido del Cliente" class="form-control">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input id="corr" name="correo" type="text" placeholder="Correo Electrónico del Cliente" class="form-control">
                                                        </div>
                                                    </div>

                                                    <div class="form-group">
                                                        <span class="col-md-1 col-md-offset-1 text-center"> <i class="fa fa-th-large" aria-hidden="true"></i><br>Paq.Estándar</span>
                                                        <div class="col-md-8">
                                                            <select class="form-control" name="paquete-1">
                                                    ...
                                                    <div class="form-group">
                                                        <span class="col-md-1 col-md-offset-1 text-center"> <i class="fa fa-th-large" aria-hidden="true"></i><br>Paq.Ultra</span>
                                                        <div class="col-md-8">
                                                            <select class="form-control" name="paquete-2">
                                                                <option value="0">Seleccione una opción</option>
                                                    ...
                                                    <div class="form-group">
                                                        <span class="col-md-1 col-md-offset-1 text-center"> <i class="fa fa-th-large" aria-hidden="true"></i><br>Paq.Master</span>
                                                        <div class="col-md-8">
                                                            <select class="form-control" name="paquete-3">
                                                                <option value="0">Seleccione una opción</option>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-12 text-center">
                                                          <input style="border:none;" id="fechaEmision" readonly="true" type="hidden" name="fechaEmision" size="10" value="16-May-2017">
                                                          <input style="border:none;" id="fechaVenc" readonly="true" type="hidden" name="fechaVenc" size="10" value="16-Jun-2017">
                                                      </div>
                                                  </div>

                                                  <div class="form-group">
                                                    <div class="col-md-12 text-center">
                                                    <button type="submit" id="reporte" class="btn btn-primary btn-lg">Presupuestar  <i class="fa fa-file-pdf-o" aria-hidden="true"></i></button>
                                                  </div>
                                              </div>
                                          </fieldset>
                                      </form>
...
var fechaEmision = curr_date + "-" + m_names[curr_month] + "-" + curr_year;
var fechaVenc = curr_date + "-" + m_names[curr_month + 1] + "-" + curr_year;

document.getElementById("fechaEmision").value = fechaEmision;
document.getElementById("fechaVenc").value = fechaVenc;
...
//Generador de Id presupuesto

var p="Pr-";
function idpresupuesto() {
    var id = function() {
      return (((110+Math.random())*0x10000)|0).toString(16).substring(1);
  };
  return ( document.getElementById("autocode").value = p+id());
}
