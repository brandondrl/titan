  ...
  public function login($user, $clave)
  {
      ...
      */
      ...
      // traemos el id y el nombre de la tabla usuarios donde el usuario sea igual al usuario ingresado y ademas la clave sea igual a la ingresada para ese usuario.
        $consulta = 'select id, nombre, usuario, cargo from usuarios where (usuario="'.$user.'" or email="'.$user.'") and clave= MD5("'.$clave.'")';
      /*
      ...
      */
      ...
      public function registrar ($nombre, $usuario, $correo, $clave){
       parent::conectar();
       ...
       if ($resultado > 0) {
        ...
        $pass= md5($clave);
        $insert = 'insert into usuarios values ("null","'.$nombre.'","'.$usuario.'","'.$correo.'", "'.$pass.'",2)';
