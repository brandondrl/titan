...
<li  class="active"><a href="gestionusuarios.php"><i class="fa fa-user">
                                            ...
                                            <div class="col-md-12">
                                                    ...
                                                    <form class="form-horizontal" method="post">
                                                      <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input id="nombre" name="name" type="text" placeholder="Nombre y Apellido" class="form-control">
                                                            </div>
                                                        </div>

                                                        <div class="form-group">
                                                            <span class="col-md-1 col-md-offset-1 text-center">   <i class="fa fa-user"></i> </span> 
                                                            <div class="col-md-8">
                                                              <input id="usuario" name="usuario" type="text" placeholder="Usuario para inicio de sesion" class="form-control" >
                                                          </div>
                                                      </div>
                                                      ...
                                                      <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input id="correo" name="email" type="text" placeholder="Correo Electrónico" class="form-control">
                                                        </div>
                                                    </div>

                                                    <div class="form-group">
                                                        <span class="col-md-1 col-md-offset-1 text-center"><i class="fa fa-lock"></i></span>
                                                        <div class="col-md-8">
                                                          <input id="clav" name="clave" type="password" autocomplete="off" placeholder="Ingresa la contraseña" class="form-control" >
                                                      </div>
                                                  </div>
                                                ...
                                                <div class="row">
                                                  <div class="col-xs-8 col-xs-offset-2">
                                                    ...
                                                    <button id="registro" name="button" type="button" class="btn btn-primary btn-block confirm">Registrar</button>
                                                </div>
                                            </div>
                                        </fieldset>
                                    </form>
