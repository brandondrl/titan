...
<body onload="mueveReloj(),idpresupuesto()">
    <div>
    ...
    <li class="active"><a href="contratacion.php"><i class="fa fa-briefcase">
                                                ...
                                                <form class="form-horizontal well well-custom" method="post" action="pedf.php">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8">
                                                              <input id="code" name="codigo-contrato" placeholder="Ingrese código de presupuesto" type="text" class="form-control" >
                                                          </div>
                                                      </div>
                                                      ...
                                                      <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                        <input id="nombreC" name="nombreC" type="text" placeholder="Nombre y Apellido del Cliente" class="form-control" readonly="">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <span class="col-md-1 col-md-offset-1 text-center"><i class="fa fa-map-marker"></i></span>
                                                        <div class="col-md-8">
                                                        <input id="cedula" name="cedula" type="text" placeholder="Cédula" class="form-control" readonly="">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <span class="col-md-1 col-md-offset-1 text-center"><i class="fa fa-map-marker"></i></span>
                                                        <div class="col-md-8">
                                                        <input id="direccion" name="direccion" type="text" placeholder="Dirección de la empresa" class="form-control" readonly="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                        <input id="corr" name="correo" type="text" placeholder="Correo Electrónico del Cliente" class="form-control" readonly="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                        <input id="telefono" name="telefono" type="text" placeholder="Teléfono del Cliente / Empresa" class="form-control" readonly="">
                                                        </div>
                                                    </div>
                                                  ...
                                                  <div class="form-group">
                                                    <div class="col-md-12 text-center">
                                                        <button type="submit" id="reporte" class="btn btn-primary btn-lg">Contratar  <i class="fa fa-file-pdf-o" aria-hidden="true"></i></button>
                                                    </div>
                                                </div>
                                            </fieldset>
                                        </form>
